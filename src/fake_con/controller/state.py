...
class ControllerState:
    ...
    def __init__(self, controller_type: ControllerType):
        ...
        self._sticks: list[list[int]] = [
            [2048] * 2 for _ in range(4)
        ]  # Centered at 2048
        self.reset()
    ...
    def set_button(self, button: Button, pressed: bool, force: bool = False):
        ...
        if (button not in SUPPORTED_BUTTONS[self._controller_type]) and not force:
    ...
    def set_stick(self, axis: StickAxis, value: int, force: bool = False):
        ...
        if (axis not in SUPPORTED_STICKS[self._controller_type]) and not force:
    ...
    def as_bytes(
        ...
        input_report_type: InputReportType | None = None,
    ) -> bytearray | None:
        ...
        report[0] = 0xA1  # Report ID for input report
        ...
        # Buttons
        report[4:7] = self.pack_buttons()

        # Sticks
        report[7:10] = self.pack_stick(
