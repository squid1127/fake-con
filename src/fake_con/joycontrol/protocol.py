...
from .mcu import MicroControllerUnit
from .memory import FlashMemory
from .report import InputReport, OutputReport, OutputReportID, SubCommand
...
# transport hooks
    ...
    async def report_received(self, data: bytes | str, addr: tuple[str, int]) -> None:
